export default function Footer() {
  return (
    <footer className="relative z-10 py-8 sm:py-10 md:py-12 px-4 sm:px-6 md:px-10 border-t border-charcoal/[0.06] bg-platinum">
      <div className="max-w-[1200px] mx-auto flex flex-col md:flex-row md:items-center md:justify-between gap-6 sm:gap-8">
      ...
      <div className="max-w-[1200px] mx-auto mt-6 sm:mt-8 pt-6 sm:pt-8 border-t border-charcoal/[0.05]">
