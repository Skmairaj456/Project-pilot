export default function Footer() {
  return (
    <footer className="relative z-10 py-6 sm:py-8 md:py-10 pb-[max(1.5rem,env(safe-area-inset-bottom))] px-4 sm:px-6 md:px-10 border-t border-charcoal/[0.08] bg-gradient-to-b from-cream/80 to-platinum shadow-[0_-2px_20px_rgba(26,26,26,0.04)]">
